...
REPO_NAME = "HIV_Inhibitor_Prediction_GNN_MLFlow-DVC"
AUTHOR_USER_NAME = "Nilansh Garg"
SRC_REPO = "hiv_gnn_classifier"  # Renamed from cnn_classifier
...
setuptools.setup(
    ...
    description="A GNN-based project for predicting HIV inhibitors using Graph Attention Networks, MLFlow, and DVC.",
